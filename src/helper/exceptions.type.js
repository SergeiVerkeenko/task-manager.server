const ExceptionType = {
  ...
  PUT_TASK_NOT_FOUND: {
    id: 13,
    message: 'updateTasks: this task is not defind.',
  },
  ...
  CREATE_TASK_NOT_FOUND: {
    id: 16,
    message: 'createTasks: this task is not defind.',
  },
  REG_USER_SAME_LOGIN: {
    id: 17,
  ...
  AUTH_USER_WITH_PWD: { id: 19, message: 'checkUserByPwdDB: wrong password.' },
};
